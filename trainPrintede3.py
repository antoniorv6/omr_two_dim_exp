...
from utils.utils import prepareOutput3, resize_image
...
def saveCheckpoint(modelToSave, fold, SER):
    modelToSave.save("checkpoints/FOLD3/model.h5")
...
def save_vocabulary(fold):
    np.save("vocabulary/3/w2i.npy", w2i)
    np.save("vocabulary/3/i2w.npy", i2w)
...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        Y_Train, Y_Test, Y_Validate = prepareOutput3(TrainY, TestY, ValidY, i2w, w2i, "Printed")
        ...
        modelToTest = load_model("checkpoints/FOLD3/model.h5")
        ...
        file = open("checkpoints/FOLD3/resume.txt", "w+")
