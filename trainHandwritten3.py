...
def saveCheckpoint(modelToSave, fold, SER):
    modelToSave.save("checkpoints/handwritten/S2SA/model3.h5")
...
def save_vocabulary(fold):
    np.save("vocabulary/handwritten/S2SA/w2i3.npy", w2i)
    np.save("vocabulary/handwritten/S2SA/i2w3.npy", i2w)
...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        modelToTest = load_model("checkpoints/handwritten/S2SA/model3.h5")
