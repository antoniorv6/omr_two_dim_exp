...
from utils.utils import prepareOutput3, resize_image, edit_distance, resize_image, LoadCameraPrimus, saveCheckpointKeras, make_single_prediction
...
def TrainLoop(model_to_train, X_train, Y_train, X_test, Y_test, FOLD, w2i, i2w, ALPHABETLENGTH):
    ...
    for epoch in range(30):
        ...
        if valNoLookEdition < best_value_eval:
            ...
            saveCheckpointKeras(model_to_train, "checkpoints/Printed/S2SA/", 3, fold)
...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        Y_Train, Y_Test, Y_Validate, w2i, i2w, ALPHABETLENGTH = prepareOutput3(TrainY, TestY, ValidY, i2w, w2i, "Printed", fold)
        ...
        modelToTest = load_model("checkpoints/Printed/S2SA/modelc3fold"+ str(fold) + ".h5")
